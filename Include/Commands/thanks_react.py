...
def weather_r(type):
    weather_type = {
        "Err": "Прости, что не смог показать тебе погоду :( Разработчики опять накосячили",
        ...
        "Дождь": "Не стоит благодарностей, Дорогуша! И не дай этому дождю встать преградой между Тобой и Твоей целью",
        ...
        "Небольшой снег": "Всегда пожалуйста! Снег -- это не всегда плохо, но оденься получше :) ",
        "Снег": "Не за что. Постарайся не заболеть, пожалуйста!",
        "Дождь со снегом": "Пожалуйста! На улице будет опять слякоть, надень-ка ты спаоги, чтобы ноги не промокли!"
    }
...
def cinema_r(_):
    return "Всегда пожалуйста! Удачного просмотра!"
